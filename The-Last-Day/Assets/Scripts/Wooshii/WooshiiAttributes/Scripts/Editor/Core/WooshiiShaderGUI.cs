...
public class WooshiiShaderGUI : ShaderGUI
    ...
    private const string GUISrc = "PreviewGUI, UnityEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
    private const string ModelSrc = "UnityEditor.ModelInspector, UnityEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
    ...
    private void DrawFOVSlider(MaterialEditor materialEditor)
        ...
        if (m_previewRenderUtility != null)
            ...
            //fov = EditorGUILayout.Slider ("Preview FOV", fov, 10, 140);
            //offset = EditorGUILayout.Vector3Field ("Preview Position Offset", offset);
